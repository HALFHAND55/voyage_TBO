          ...
          {[1, 2, 3, 4].map((item) => (
            <div key={item} className="event-card">
              <div
                ...
                style={{
                  backgroundImage: `url(https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?auto=format&fit=crop&q=80&w=400)`
                }}
              ></div>
          ...
          {[1, 2, 3, 4].map((item) => (
            <div key={item} className="event-card">
              <div
                className="event-image"
                style={{
                  backgroundImage: `url(https://images.unsplash.com/photo-1519741497674-611481863552?auto=format&fit=crop&q=80&w=400)`
                }}
              ></div>
              <div className="event-details">

      ...
      <div className="event-banner mb-4">
        <div className="banner-content">
          ...
          <div className="event-meta">
            <span>
              <Calendar size={16} /> September 20, 2024
            </span>
            <span>
              <Clock size={16} /> 4:00 PM - 11:00 PM
            </span>
            <span>
              <MapPin size={16} /> The Grand Palace, New York
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="guest-grid">
        <div className="main-info">
          ...
          <div className="card p-6">
            ...
            <textarea
              className="msg-input"
              placeholder="Send a message or wish to the couple..."
            ></textarea>
        ...
        <div className="sidebar-info">
          <div className="card p-6 mb-4">
            ...
            <div className="status-box confirmed">Confirmed</div>
          ...
          <div className="card p-6">
            ...
            <button className="btn text-primary mt-2">
              Get Directions
            </button>
          </div>
        </div>
      ...
      <style>{`
        .event-banner {
          background: linear-gradient(rgba(0,0,0,0.6), rgba(0,0,0,0.6)), 
            url('https://images.unsplash.com/photo-1519225421980-6f03b7a1cd1d?auto=format&fit=crop&q=80&w=1600');

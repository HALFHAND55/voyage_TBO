export const VENDOR_PACKAGES = [
  {
    ...
    description:
      'A luxurious experience fit for royalty with complete event management.'
  },
  {
    id: 'pkg_2',
    ...
    description:
      'Romantic sunset wedding package with ocean views.'
  },
  {
    id: 'pkg_3',
    ...
    description:
      'Perfect for intimate gatherings in a lush natural setting.'
  },
  {
    id: 'pkg_4',
    name: 'Urban Chic',
    ...
    description:
      'Contemporary city wedding with skyline views.'
  },
  {
    id: 'pkg_5',
    ...
    description:
      'Full-service conference package including tech support.'
  }
];
